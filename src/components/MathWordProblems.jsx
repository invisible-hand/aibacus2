...
const basePrompt =
  ...
  '`{"grade": <grade>, "subject": "math", "type": "word", "assignments": [{ "assignment":{"task": <task>,"answers":[{"number":<number>, "units": <units>},{"numbers":<number>, "units": <units>},...],"solution": <solution>}},{ "assignment":...},...]}`. ' +
...
export default MathWordProblems;
